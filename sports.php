...
<?php
    ...
    $query=mysqli_query($conn,"SELECT * FROM game WHERE genre=2");
        ...
        <div class="container">
                    ...
                    <div class="owl-testimonials2 owl-carousel" style="position: relative; z-index: 5;">
                        ...
                        <div class="item">
                            ...
                            <div class="right-image">
                                ...
                                <h4>
                                 <a href="game-detail-view.php?id=<?=$res['ID']?>"><?=$res['name']?></a>
                                </h4>
                                <div class="right-image">
                                ...
                                if(isset($_SESSION['id'])){
                                    ...
                                    <button type="button" class="btn btn-primary" data-toggle="modal"    data-target="#exampleModal<?=$res['ID']?>" data-whatever="@mdo">Edit
                                     ...
                                     <p align="right">
                                       <a href="delete_entry.php?id=<?=$res['ID']?>&place=sports">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" class="form-control" name="page" value="sports.php">

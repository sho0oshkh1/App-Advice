...
$query=mysqli_query($conn,"SELECT * FROM game WHERE genre=1");
        ...
        <div class="container">
                        ...
                        <div class="item">
                            ...
                            <div class="right-image">
                                ...
                                if(isset($_SESSION['id'])){
                                    ...
                                    <p align="right">
                                       <a href="delete_entry.php?id=<?=$res['ID']?>&place=action">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" class="form-control" name="page" value="action.php">
